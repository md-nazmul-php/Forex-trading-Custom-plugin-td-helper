...
class td_crypto_List_Table extends WP_List_Table
{
...
'edit' => sprintf('<a href="?page=add-td-helper&id=%s">%s</a>', $item['id'], __('Edit', 'fxtable')),
...
function td_crypto_admin_menu()
{
	
add_menu_page(
	__('TD Helper', 'td-helper'),
	__('TD Helper', 'td-helper'),
	'activate_plugins',
	'td-helper', //slug
	'td_crypto_handler_cb', // callback
...
add_submenu_page(
	...
	'activate_plugins',
	'add-td-helper',
	'td_crypto_datas_form_page_handler_cb',
	10
);
}
add_action('admin_menu', 'td_crypto_admin_menu');


if (!function_exists('td_crypto_validate_datas')):
function td_crypto_validate_datas($item)
{
$messages = array();
