...
if (!function_exists('td_forex_handler_cb')):
function td_forex_handler_cb()
{
global $wpdb;
$table = new td_forex_List_Table();
$table->prepare_items();
$message = '';
...
<div class="wrap">
    ...
    <h2><?php _e('Forex Data Table', 'add-td-helper-forex')?> <a class="add-new-h2"
    href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=add-td-helper-forex');?>"><?php _e('Add new', 'td-helper-forex')?></a>
    </h2>
    <div style="padding: 1px 1px; margin:0px auto; background-color: white; text-align: center;">
    <p style="color: green;">Please use shortcode <b style="color: red;">[td-forex-table]</b> too display this table in your post or page.</p>
</div>
    <?php echo $message; ?>
...
if (!function_exists('td_forex_datas_form_page_handler_cb')):
function td_forex_datas_form_page_handler_cb()
{
global $wpdb;
...
$item_valid = td_forex_validate_datas($item);
if ($item_valid === true) {
if ($item['id'] == 0) {
...
add_meta_box('datas_form_meta_box', __('Add Data', 'td-helper'), 'td_forex_datas_form_meta_box_handler_cb', 'data', 'normal', 'default');
?>
<div class="wrap">
    <div class="icon32 icon32-posts-post" id="icon-edit"><br></div>
    <h2><?php _e('Adding Forex Data', 'td-helper')?> <a class="add-new-h2"
    href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=td-helper-forex');?>"><?php _e('View Data Table', 'td-helper')?></a>
    </h2>
    <?php if (!empty($notice)): ?>
...
// <!-- ==========    Start form to insert meta data ======== -->
if (!function_exists('td_forex_datas_form_meta_box_handler_cb')):
function td_forex_datas_form_meta_box_handler_cb($item)
{
?>
<tbody >
